...
-export([launch_bot/3]).
-export([get_me/1, send_message/2, delete_message/2, edit_message/2, forward_message/2, send_photo/2, send_audio/2,
...
edit_message(Bot, #{chat_id := _, message_id := _, text := _} = Req) ->
